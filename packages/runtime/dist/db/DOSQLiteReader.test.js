...
describe("DOSQLiteReader", () => {
    describe("getDocument()", () => {
        it("returns document with deserialized data", async () => {
            ...
            expect(sql.exec).toHaveBeenCalledWith(expect.stringContaining("WHERE _id = ? AND _ts <= ?"), `tasks:${ULID}`, 100);
        });
    ...
    describe("getDocuments()", () => {
        it("returns map of documents", () => {
            ...
            expect(result.get(id1).data.title).toBe("A");
        });
...
//# sourceMappingURL=DOSQLiteReader.test.js.map