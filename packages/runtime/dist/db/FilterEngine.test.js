...
import { applyFilter, evaluateFilter, applyOrder, applyLimit, compileFilterToSQL, } from "./FilterEngine";
const rows = [
...
describe("evaluateFilter", () => {
    ...
    it("unknown op defaults to true", () => {
        expect(evaluateFilter(rows[0], { op: "unknown" })).toBe(true);
    });
});
...
//# sourceMappingURL=FilterEngine.test.js.map