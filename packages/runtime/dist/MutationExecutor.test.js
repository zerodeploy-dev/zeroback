...
function makeDeps(overrides = {}) {
    ...
    return {
        ...
        reader: { getDocument: vi.fn().mockResolvedValue(null) },
        writer: { commitWrites: vi.fn().mockResolvedValue(undefined) },
        sql: {
...
describe("executeMutation", () => {
    it("executes function and returns result", async () => {
        ...
        expect(deps.invokeFunction).toHaveBeenCalledWith("api:tasks:create", { title: "Test" }, expect.any(String) // txId
        );
    });
    ...
    it("retries on OCC conflict", async () => {
        ...
        const deps = makeDeps({
            transactions,
            sql: {
                exec: vi.fn().mockImplementation((query) => {
...
//# sourceMappingURL=MutationExecutor.test.js.map