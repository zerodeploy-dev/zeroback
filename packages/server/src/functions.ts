import type { PropertyValidators, ObjectType } from "@vex/values";
...
function makeQueryFactory<DataModel>(isInternal: boolean) {
  ...
  }): RegisteredQuery<ObjectType<Args>, Returns> & { handler: (ctx: QueryCtx<DataModel>, args: ObjectType<Args>) => Promise<Returns>; _argsValidator: Args } {
    return {
      _name: "anonymous",
      _type: "query",
...
function makeMutationFactory<DataModel>(isInternal: boolean) {
  ...
  }): RegisteredMutation<ObjectType<Args>, Returns> & { handler: (ctx: MutationCtx<DataModel>, args: ObjectType<Args>) => Promise<Returns>; _argsValidator: Args } {
    return {
      _name: "anonymous",
      _type: "mutation",
      _isInternal: isInternal,
...
function makeActionFactory<DataModel>(isInternal: boolean) {
  ...
  }): RegisteredAction<ObjectType<Args>, Returns> & { handler: (ctx: ActionCtx<DataModel>, args: ObjectType<Args>) => Promise<Returns>; _argsValidator: Args } {
    return {
      _name: "anonymous",
      _type: "action",
      _isInternal: isInternal,
